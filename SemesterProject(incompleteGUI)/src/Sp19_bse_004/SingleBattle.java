...
public class SingleBattle extends Battle {
    ...
    public void battle() {
        ...
        System.out.println("your opponent is " + StoryMode.list.get(37));
        if (a == 1) {
        ...
        if (a == 2) {
            ...
            if (r == 1) {
                System.out.println(StoryMode.list.get(37) + "has faded you won");
                i += 1;
            }
        ...
        if (i == 1) {
            ...
            System.out.println("press 5 to select" + StoryMode.myList.get(4));
            System.out.println("press 6 to select" + StoryMode.myList.get(5));
            System.out.println("your opponent is " + StoryMode.list.get(75));
            a = scanner.nextInt();
            if (a == 1) {
                System.out.println("you choosed" + StoryMode.myList.get(0));
                System.out.println(StoryMode.myList.get(0) + "has faded you Lost");
        ...
        if (i == 2) {
            ...
            System.out.println("press 5 to select" + StoryMode.myList.get(4));
            System.out.println("press 6 to select" + StoryMode.myList.get(5));
            System.out.println("your opponent is " + StoryMode.list.get(129));
            a = scanner.nextInt();
            if (a == 1) {
                System.out.println("you choosed" + StoryMode.myList.get(0));
                System.out.println(StoryMode.list.get(129) + "has faded you won");
                i += 1;
            }
            if (a == 2) {
                System.out.println("you choosed" + StoryMode.myList.get(1));
        ...
        if (i == 2) {
            ...
            System.out.println("press 5 to select" + StoryMode.myList.get(4));
            System.out.println("press 6 to select" + StoryMode.myList.get(5));
            System.out.println("your opponent is " + StoryMode.list.get(70));
            a = scanner.nextInt();
            if (a == 1) {
                System.out.println("you choosed" + StoryMode.myList.get(0));
                if (r == 0) {
                ...
                if (r == 1) {
                    System.out.println(StoryMode.list.get(70) + "has faded you won");
                    i += 1;
                }
                if (a == 2) {
                    System.out.println("you choosed" + StoryMode.myList.get(1));
        ...
        if(i==3){
            System.out.println("you have completed storymode");
        }
    }
